...
class _NoteState extends State<Note> {
  ...
  void _saveMsg(String msg) async {
    CollectionReference fire = FirebaseFirestore.instance.collection('messages');
    String usern = nickController.text == "" ? "NN" : nickController.text;
    await fire.add({"message": msg, "user": usern, "date": DateTime.now().toLocal()});
  }
  ...
  void sendMsg(String msg) {
    ...
    _saveMsg(msg);
    scrollController.animateTo(0.0, duration: Duration(milliseconds: 500), curve: ElasticInCurve(),);
    txtController.clear();
  }
